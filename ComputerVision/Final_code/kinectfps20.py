...
from cythonfps20 import align
from cythonfps20 import segment
import cmath 
from cythonfps20 import coordinates_gui_to_kinect
from cythonfps20 import coordinates_kinect_to_gui
import time
import socket
...
def update():
    ...
    #img2 = segment(array,new_depth, image2, 0.5,1.8)
    img2 = array
    ...
    for finger in fingertips:
        ...
        for i in range(-10,10):
            for j in range(-10,10):
                if(finger[1]+j<640 and finger[1]+j>0 and finger[0]+i<480 and finger[0]+i>0):
    ...
    if(touch > nottouch):
        ...
        is_touchedcurr = 0    
    if(is_touchedprev == 0 and is_touchedcurr == 1):
        print("Click")
    if(is_touchedprev == 1 and is_touchedcurr == 0):
        print("Lift")
        is_clicked = 1
    ...
    if(index[0]!=0 and index[1]!=0):
        ...
        send_string = str(p) + "," + str(q) + "," + str(is_clicked) 
